...
public class LocalSurfaceView extends SurfaceView implements SurfaceHolder.Callback, Camera.PreviewCallback {
    ...
    public void startCapture(SocketLiveClient.SocketCallback socketCallback) {
        cameraH264Encod = new CameraH264Encod(cameraSize.width, cameraSize.height, socketCallback);
        // 启动MediaCodec编码器
        cameraH264Encod.startLive();
        // 需要再执行一次，才能回调onPreviewFrame（）
        startPerview();
    }
