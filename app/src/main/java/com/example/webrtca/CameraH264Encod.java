...
public class CameraH264Encod {
    ...
    SocketLiveClient socketLive;

    @RequiresApi(api = Build.VERSION_CODES.JELLY_BEAN_MR2)
    public CameraH264Encod(int width, int height, SocketLiveClient.SocketCallback socketCallback) {
        socketLive = new SocketLiveClient(socketCallback);
        socketLive.start();
        this.width = width;
        this.height = height;
    }
